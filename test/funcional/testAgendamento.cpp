...
void TestAgendamento::testFluxoAgendamentoCompleto() {
    ...
    telaEsp.show();
    QVERIFY(telaEsp.isVisible());

    QTest::qWait(1500);

    // Buscando o botão de Dentista na interface
    QPushButton* btnDentista = telaEsp.findChild<QPushButton*>();
    //procurar o botao que tem o texto "Dentista"
